...
qtext = "<p>Consider the following application of Boolean identities on the expression a+bcd:</p><pre>" \
"a+bcd = a+b(cd)         (by the Associative Property)<br>" \
"      = (a+b)(a+cd)     (by the Distributive Property)<br>" \
"      = (a+b)(a+c)(a+d) (by the Distributive Property) </pre>" \
"<p>Knowing this, write a Boolean expression that is equivalent to {exp} which does not use parenthesis.</p>"
